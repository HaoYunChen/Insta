...
from Ins.views import Helo, PostDetailView, PostsView, PostCreateView, PostUpdateView, PostDeleteView, addLike, UserDetailView, addComment, follow, ProfileUpdateView, UsersView
